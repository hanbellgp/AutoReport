...
{
    public class Cdrcusxgb : NotificationContent
    {
        ...
        protected override void Init()
        {
            ...
            nc = new CdrcusxgbConfig(Core.DBServerType.MSSQL, "EFGP");
            ...
            "传真","业务负责人","其他","修改后单位名称","修改后付款方式","修改后其他付款方式","修改后地址","修改后银行名称",
            "修改后银行帐号","修改后税号","修改后联络人","修改后电话1","修改后传真","修改后业务负责人","修改后其他","原因说明",};
