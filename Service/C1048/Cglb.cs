...
{
    public class Cglb : NotificationContent
    {
        ...
        protected override void Init()
        {
            ...
            nc = new CglbConfig(DBServerType.SybaseASE, "SHBERP");
            nc.InitData();
            nc.ConfigData();
            ...
            string[] title = { "采购类别", "厂商代号", "厂商简称","本年占比%" ,"本月占比%","本年金额", "本月金额",
                                 "去年同期金额", "去年全年金额","同期去年%","去年全年%","去年同期成长率%","去年全年成长率%","小类占比%"};
            int[] width = { 100, 70, 70, 80, 80, 80, 80, 90, 90, 80, 80, 80, 80, 70 };
