...
{
  public  class NFWLLD : NotificationContent
    {
      ...
      protected override void Init()
      {
          ...
          nc = new NFWLLDConfig(Core.DBServerType.MSSQL, "SHBOA");
          //nc = new NFWLLDConfig(DBServerType.SybaseASE, "SHBERP");
          ...
          string[] title = { "部门代号", "部门名称", "服务领料单单号", "服务单号", "客服单号", "处理责任人姓名", "单据年/月" };
      ...
      protected override void SendAddtionalNotification()
      {
          ...
          string[] title = new string[] { "部门代号", "部门名称", "服务领料单单号", "服务单号", "客服单号", "处理责任人姓名", "单据年/月" };
