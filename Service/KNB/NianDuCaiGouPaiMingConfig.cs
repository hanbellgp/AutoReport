...
{
    public class NianDuCaiGouPaiMingConfig : NotificationConfig
    {
        ...
        public override void InitData()
        {
            ...
            apmpyh.facno = 'KB' and apmpyh.prono = '1' and
            ...
            AND (apmpyh.facno = 'KB' and apmpyh.prono = '1' and
            ...
            LEFT JOIN  purhad on (purhad.facno = apmpyh.facno) and (purhad.prono = apmpyh.prono) and (purhad.pono = apmpyh.pono)
            WHERE (apmpyh.pyhkind = '1')
            AND (apmpyh.facno = 'KB' and apmpyh.prono = '1'  
