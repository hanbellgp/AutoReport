...
namespace C0241 {
    ...
    public class FWKCGLReport : ReportClass {
    ...
    public class CachedFWKCGLReport : Component, ICachedReport {
        
        public CachedFWKCGLReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            FWKCGLReport rpt = new FWKCGLReport();
            rpt.Site = this.Site;
            return rpt;
        }
