...
{
    public class TCHU : NotificationContent
    {
        ...
        protected override void Init()
        {
            ...
            nc = new TCHUConfig(DBServerType.SybaseASE, "SHBERP", this.ToString());
            nc.InitData();
            nc.ConfigData();
            ...
            //string[] title = { };
            this.content = GetContent(nc.GetDataTable("TCHU"), title, width);
