...
{
    public class QinggousantianweipaozhuanConfig : NotificationConfig
    {
        public QinggousantianweipaozhuanConfig()
        {
        }

        public QinggousantianweipaozhuanConfig(DBServerType dbtype, string connName, string notification)
        {
