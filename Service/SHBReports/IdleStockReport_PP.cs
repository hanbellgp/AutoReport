...
namespace Hanbell.AutoReport.Config {
    ...
    public class IdleStockReport_PP : ReportClass {
        
        public IdleStockReport_PP() {
        }
        
        public override string ResourceName {
            get {
                return "IdleStockReport_PP.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Hanbell.AutoReport.Config.IdleStockReport_PP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedIdleStockReport_PP : Component, ICachedReport {
        
        public CachedIdleStockReport_PP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            IdleStockReport_PP rpt = new IdleStockReport_PP();
            rpt.Site = this.Site;
            return rpt;
        }
