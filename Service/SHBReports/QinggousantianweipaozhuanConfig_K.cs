...
{
    class QinggousantianweipaozhuanConfig_K : NotificationConfig
    {
        public QinggousantianweipaozhuanConfig_K()
        {
        }
        public QinggousantianweipaozhuanConfig_K(DBServerType dbtype, string connName, string notification)
        {
