...
{
    class YiyanshouweiquerenConfig_K : NotificationConfig
    {
        public YiyanshouweiquerenConfig_K()
        { 
        }
                public YiyanshouweiquerenConfig_K(DBServerType dbType, string connName, string notification)
        {
