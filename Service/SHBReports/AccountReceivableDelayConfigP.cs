...
{
    class AccountReceivableDelayConfigP : NotificationConfig
    {
        public AccountReceivableDelayConfigP() { }

        public AccountReceivableDelayConfigP(DBServerType dbType, string connName, string notification) 
        {
