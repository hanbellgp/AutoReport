...
{
    class WeilaiyizhouxujiaohuoConfig_V : NotificationConfig
    {
                public WeilaiyizhouxujiaohuoConfig_V()
        { 
        }
                public WeilaiyizhouxujiaohuoConfig_V(DBServerType dbType, string connName, string notification)
        {
