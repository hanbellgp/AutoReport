...
{
    class YuqiweijieancaigoudanConfig_K : NotificationConfig
    {
        public YuqiweijieancaigoudanConfig_K()
        { 
        }
        public YuqiweijieancaigoudanConfig_K(DBServerType dbType, string connName, string notification)
        {
        ...
        public override void InitData()
        {
            ...
            Fill(String.Format(sb.ToString(), args["facno"]), ds, "tblresult2" );
        }
    }
}
