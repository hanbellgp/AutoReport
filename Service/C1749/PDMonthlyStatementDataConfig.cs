                ...
                if (!"".Equals(type))
                {
                    switch (type)
                    {
                        ...
                        case "成本":
                            ...
                            {
                                case "刀具":
                                    sb.Append(" and depno='1P100' and itnbr like 'B101%' ");
                                    break;
                                case "钻头丝攻铣刀":
                                    sb.Append(" and depno='1P100' and (itnbr like 'B102%' or itnbr like 'B103%' or itnbr like 'B104%' or  itnbr like 'B105%' )  ");
                                    break;
                                case "刀柄类":
                                    sb.Append(" and depno='1P100'  ");
                                    sb.Append(" and (itnbr like 'B106%' or itnbr like 'B151%' or itnbr like 'B152%' or  itnbr like 'B153%'  or  ");
                                    sb.Append(" itnbr like 'B154%' or  itnbr like 'B155%' or  itnbr like 'B156%' or  itnbr like 'B157%' or  itnbr like 'B158%')  ");
                                    break;
                                case "NSM":
                                    sb.Append(" and depno in('1P121','1P122') and itnbr  like 'B101-01%'  ");
                                    break;
                                case "NL+CG":
                                    sb.Append(" and  depno in('1P121','1P122')   ");
                                    sb.Append(" and ((itnbr like 'B101-06%' or itnbr like 'B101-07%' or itnbr like 'B101-08%' or  itnbr like 'B101-09%'  ");
                                    sb.Append(" or  itnbr like 'B108-01%' or  itnbr like 'B104-03%' or  itnbr like 'B109%'  or  itnbr like 'B110%')  ");
                                    sb.Append(" and (itnbr  not like 'B101-01%' and itnbr not like '52%'))  ");
                                    break;
                                default:
                                    break;
                            }
                        ...
                        case "KAPP":
                            ...
                            sb.Append(" and purdta.itnbr like 'C401%'  ");
