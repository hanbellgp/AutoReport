...
namespace Hanbell.AutoReport.Config
{
    class ProductiveTurnoverConfig:NotificationConfig
    {
        ...
        public override void InitData()
        {
            ...
            sb.Append(" p.vdrna,cgwj,isnull(p.leadtime,0) as leadtime,'' AS 'cy',p.pominqy,q.safqy,q.maxqy,a.lindate ");
            sb.Append(" FROM ( ");
            sb.Append(" SELECT a.facno,a.prono,a.itcls,s.clsdsc, a.itnbr,m.itdsc,m.genre1,a.wareh, a.trnqys,b.onhand1,b.lindate ");
            ...
            sb.Append(" FROM purdta WHERE facno = 'C' AND prono = '1'  AND ( poqy1  -  okqy1 )>0 and dposta not in ('98','99') ");
            ...
            sb.Append(" h.facno = 'C' and h.prono = '1'  and h.iocode = '2'  ");
            sb.Append(" and d.syscode IN ('10') ");
            ...
            //sb.Append(" ON a.facno = b.facno AND a.prono = b.prono AND a.itnbr = b.itnbr   ");
            //-->
            sb.Append(" WHERE  a.facno = 'C' AND a.prono = '1' AND a.trnqys >0  ");
            sb.Append(" AND a.wareh IN  ").Append(wareh);
            ...
            sb.Append(" h.trtype = d.trtype AND ");
            sb.Append(" h.facno = 'C' and h.prono = '1'  and h.iocode = '2'  ");
            sb.Append(" and d.syscode IN ('50','30')  ");
            sb.Append(" and h.yearmon = convert(VARCHAR(6),DATEADD(MONTH,-1,getdate()),112) ");
            sb.Append(" group BY h.facno,h.prono,h.itnbr,h.yearmon) h1 ON a.facno = h1.facno AND a.prono = h1.prono AND a.itnbr = h1.itnbr ");
            sb.Append(" LEFT JOIN   (  ");
            sb.Append(" SELECT h.facno,h.prono,h.itnbr,h.yearmon,sum(h.trnqys)  as trnqyh2 FROM invmon h,invdou d WHERE ");
