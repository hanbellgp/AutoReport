...
{
    class PDMonthlyStatementData_YX : NotificationContent
    {
        public PDMonthlyStatementData_YX() { }
        protected override void Init()
        {
            ...
            {
                ////圆形件产出工时
                string fileFullName2 = Base.GetServiceInstallPath() + "\\Data\\" + "圆形件产出工时表" + DateTime.Now.AddMonths(-1).ToString("yyyy-MM") + ".csv";
                DataTableToCSV(nc.GetDataTable("tlb2"), fileFullName2, true);
                //发送
