...
namespace Hanbell.AutoReport.Config
{
    class GuestComplaints:NotificationContent
    {
        ...
        protected override void Init()
        {
            ...
            string[] title = { "责任部门", "案件编号", "客户代号", "客户简称", "问题描述", "产品别", "区域别", "客诉类别", "责任判定", "收费否", "结案码","结案日期", "是否客诉", "原因分析说明", "接案日期", "是否在原厂保固期" };
            int[] width = { 100, 120, 120, 120, 80, 80, 80, 80, 80, 80, 80, 80, 100, 80, 80,80 };
