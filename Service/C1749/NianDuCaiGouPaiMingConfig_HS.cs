...
{
    class NianDuCaiGouPaiMingConfig_HS : NotificationConfig
    {
        public NianDuCaiGouPaiMingConfig_HS(DBServerType dbType, string connName, string notification) 
        {
        ...
        {
            //查询年度年度采购金额   
            String sqlStr = @"select top 50 convert(varchar(4),a.trdat,112) as yer,a.vdrno,a.vdrna ,0 as m_puramt, 0 as m_order,
            ...
            WHERE apmaph.facno = 'H' and apmaph.apsta <> '99'
...
//            apmpyh.facno = 'H' and apmpyh.prono = '1' and
//            year(apmpyh.trdat)= 2018))a
...
//            AND (apmpyh.facno = 'H' and apmpyh.prono = '1' and
//            convert(varchar(6),apmpyh.trdat,112)= '201812'))a
...
//            LEFT JOIN  purhad on (purhad.facno = apmpyh.facno) and (purhad.prono = apmpyh.prono) and (purhad.pono = apmpyh.pono)
//            WHERE (apmpyh.pyhkind = '1')
//            AND (apmpyh.facno = 'H' and apmpyh.prono = '1'  
//            and convert(varchar(6),apmpyh.trdat,112) <=  '201712'
//            and convert(varchar(4),apmpyh.trdat,112) = '2017'))a 
//            GROUP BY convert(varchar(4),a.trdat,112),a.vdrno,a.vdrna 
//            order by sum(a.acpamt) desc";
