...
{
    class NianDuCaiGouPaiMing_HS:NotificationContent
    {
        public NianDuCaiGouPaiMing_HS() 
        {
        ...
        {
            base.Init();
            nc = new NianDuCaiGouPaiMingConfig_HS(DBServerType.SybaseASE, "HansonERP", this.ToString());
            nc.InitData();
            nc.ConfigData();
        ...
        protected DataTable getVdrType()
        {
            ...
            sb.Append(" WHERE a.Facno='H' AND a.Vdrno IS NOT NULL and c.Name is not null ");
